...
public class CommonContext : FrostingContext
{
    ...
    /// </summary>
    /// <remarks>
    /// Relative path built from "Saritasa.Cake.csproj" folder.
    /// DefaultValue - "..\\..\\..\\".
    /// Was override if invoke "Saritasa.Cake.ps1" with "solutionDir" argument (.\Saritasa.Cake.ps1 --solutionDir ..\\SolutionFolder\\).
    /// </remarks>
