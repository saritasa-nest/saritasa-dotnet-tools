...
{
    /// <summary>
    /// The implementation class should provide method to convert to/from
    /// <see cref="MessageRecord" /> and <see cref="IMessageContext" />.
    /// </summary>
    public interface IMessageRecordConverter
    {
        /// <summary>
        /// Converts <see cref="MessageRecord" /> to <see cref="IMessageContext" />.
        /// </summary>
        ...
        /// <summary>
        /// Creates message record from <see cref="IMessageContext" />.
        /// </summary>
