...
{
    /// <summary>
    /// The SELECT statement PostgreSQL builder.
    /// </summary>
    /// <seealso cref="Saritasa.Tools.Messages.Internal.SelectStringBuilder" />
    internal class PostgreSqlSelectStringBuilder : SelectStringBuilder
    {
        /// <inheritdoc />
                ...
                foreach (var clause in JoinStatement)
                {
                    ...
                    switch (clause.JoinType)
                    {
                        ...
                        case JoinType.RightJoin:
                            ...
                            break;
                        default:
                            throw new ArgumentOutOfRangeException(nameof(clause.JoinType), $"PostgreSQL doesn't support {clause.JoinType} join type.");
                    }
